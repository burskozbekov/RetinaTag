$setup = 'C:\Users\dede_\Desktop\RetinaTag\.claude\worktrees\beautiful-blackwell\src-tauri\target\release\bundle\nsis\RetinaTag_1.5.371_x64-setup.exe'
# Guard: never uninstall the working version unless the new installer
# actually exists. A failed build once left the machine with NO app
# because the script uninstalled first, then could not find setup.
