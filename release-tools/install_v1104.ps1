...
if ($p) {
    ...
    Write-Host ("PID {0} v{1} Resp={2} Mem={3}MB Threads={4}" -f $p.Id, (Get-Item 'C:\Users\dede_\AppData\Local\RetinaTag\retina-tag.exe').VersionInfo.ProductVersion, $p.Responding, $mb, $p.Threads.Count)
}
